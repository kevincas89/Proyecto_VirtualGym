    ...
    class UsuarioRepository
    {
        ...
        public int Modificar(Usuario usuario)
        {
            using (var command = _connection.CreateCommand())
            {
                ...
                command.Parameters.Add(":NombrePlan", OracleDbType.Varchar2).Value = usuario.Nombre;
                command.Parameters.Add(":ValorPlan", OracleDbType.Decimal).Value = usuario.ValorPlan;
                command.Parameters.Add(":Duracion", OracleDbType.Int64).Value = usuario.Dias;
                command.Parameters.Add(":CodPlan", OracleDbType.Varchar2).Value = usuario.CodigoPlan;
